...
$Global:WgoSharedFunctionNames = @(
    ...
    'Set-WgoExtraPrivacy', 'Set-WgoAdvancedTweaks', 'Set-WgoBlockDriverUpdates', 'Set-WgoPagefile', 'Get-WgoOptimizedPagefileSize', 'Remove-WgoPathSafely',
    'Set-WgoMoreOptimizations', 'Restore-WgoDefaults', 'Invoke-WgoStandbyListPurge',
    'Update-WgoSessionEnvironment',
    'Find-WgoWinget', 'Install-ViaWinget', 'Find-WgoScoop', 'Test-WgoScoopCore', 'Install-WgoScoop', 'Update-WgoScoopStatus', 'Install-ViaScoop',
